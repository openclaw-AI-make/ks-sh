...
pal_backup() {
  cd ~
  curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/pal_backup.sh && chmod +x pal_backup.sh
}
...
case $choice in
  ...
  10)
    clear
    tmux kill-session -t my1
    cd ~ && curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/PalWorldSettings.ini
  ...
  k)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/ks.sh && chmod +x kejilion.sh && ./kejilion.sh
    exit
    ;;

  00)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/pal_log.sh && chmod +x pal_log.sh && ./pal_log.sh
    rm pal_log.sh
    echo ""
    curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/palworld.sh && chmod +x palworld.sh
    echo "脚本已更新到最新版本！"
    break_end
    palworld
    ;;
