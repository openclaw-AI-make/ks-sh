...
mc_backup() {
  cd ~
  curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/mc_backup.sh && chmod +x mc_backup.sh
}
...
case $choice in
  ...
  00)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/mc_log.sh && chmod +x mc_log.sh && ./mc_log.sh
    rm mc_log.sh
    echo ""
    curl -sS -O https://raw.githubusercontent.com/openclaw-AI-make/ks-sh/main/sh/main/mc.sh && chmod +x mc.sh
    echo "脚本已更新到最新版本！"
    break_end
    mc
    ;;
